...
<head>
    ...
    <title> Login - Viagem dos Sonhos | Agência de Viagens </title>
...
<body>
    ...
    <div class="container">
        <div class="row mt-5 mb-5">
            <div class="col-md-6">
                <img class="img_login img-fluid" src="img_site/sucesso.png" alt="Imagem login">
            </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body bg-modal">
                                    ...
                                    <form action="" method="">
                                        ...
                                        <label class="mt-2" for="senha"> <strong> Nome completo: </strong> </label>
                                        ...
                                        <label class="mt-2" for="senha"> <strong> Digite seu e-mail: </strong> </label>
                                        ...
                                        <input type="password" class="form-control" name="senha" id="senha_login"
                                            aria-describedby="helpId" placeholder="Digite sua senha (máx 12 digitos)"
                                        ...
                                        <input type="password" class="form-control" name="senha" id="senha_login"
                                            ...
                                            placeholder="Digite sua senha novamente (máx 12 digitos)" maxlength="12"
                                            required="">
                ...
                <form action="" method="">
                    <div class="row mb-2 mt-2">
                        <input type="email" class="form-control" name="email" id="email_login" aria-describedby="helpId"
                            placeholder="Digite seu e-mail (nome@dominio.com)" maxlength="40" required="">

                    </div>

                    <div class="row">
                        <input type="password" class="form-control" name="senha" id="senha_login"
                            aria-describedby="helpId" placeholder="Digite sua senha (máx 12 digitos)" maxlength="12"
                            required="">
                    </div>
