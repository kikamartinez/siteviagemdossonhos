...
<cabeça>
    ...
    <title> Promoções - Ir Para | Agência de Viagens </title>
                    ...
                    <div class="collapse navbar-collapse parente" id="collapsibleNavId">
                        <ul class="navbar-nav me-auto mt-2 mt-lg-0 ">
                            ...
                            <li class="nav-item text-center">
                                <a class="nav-link btn-hover bg-active" href="#">PROMOÇÕES</a>
                            </li>
                            <li class="nav-item text-center">
        ...
        <main class="container-fluid mb-5">
            <div class="linha mb-2">
                <div class="col-12 mt-5 text-center">
                    <h2 class="mb-4 animation"> PASSAGENS COM ATÉ 50% DE DESCONTO </h2>
                </div>
            </div>
